...
const PROJECT_DETAILS = {
  ...
  "restituzione-tirocinio": {
    ...
    description: {
      zh: "向班级和教师展示企业实习经历的PowerPoint演示。Chris 的个人项目涉及自主管理敏感的企业数据向SmartSuite平台的传输。演示展示了在真实企业环境中工作的经验，以及如何小心处理数据保护。",
      en: "Presentazione PowerPoint dell'esperienza di tirocinio aziendale davanti alla classe e ai docenti. Il progetto personale di Chris riguardava la gestione autonoma dei dati sensibili aziendali verso la piattaforma SmartSuite, imparando l'importanza della precisione e del rispetto dei protocolli di data handling.",
    },
