...
const PROJECT_DETAILS = {
  ...
  "monta-smonta": {
    ...
    description: {
      zh: "数据：02/2024（2024/2025学年）\n地点：Reggio Emilia\n\n描述：在一次实验室活动中，我拆卸并重新组装了一台台式电脑。我识别了每个组件（CPU、RAM、硬盘、主板、电源、散热器、风扇）并理解了它们在生态系统中的作用。这次经历教会了我互联的组件如何形成一个集成系统，以及实际维护如何需要精度和对规格的了解（兼容连接器、正确方向、热管理）。\n\n技术能力：\n- 硬件组件：CPU（接口和导热膏）、RAM（插槽）、存储（SATA、M.2）\n- 电源：电压、电源连接器、能量分配\n- 散热：风扇、导热膏、气流路径\n- 连接器和接口：PCI、USB、内部音频\n- 故障排除：启动故障诊断、组件更换\n\n跨界能力：\n- 手动精度：精细处理脆弱的组件\n- 注意细节：正确方向、牢固的连接\n- 团队合作：与同学协调进行同时活动\n- 责任：谨慎处理昂贵的设备",
  ...
  linux: {
    ...
    description: {
      zh: "数据：02/2023（2024/2025学年）\n地点：Reggio Emilia\n\n描述：我系统地研究了Linux操作系统，专注于Ubuntu发行版，共完成5堂课，共10小时的学习。我了解了开源系统的特性和结构，将其与其他操作系统进行了比较。这次经历教会了我设计范式（模块化、代码透明度、社区）如何影响系统相对于专有系统的运作方式。\n\n技术能力：\n- Linux/Bash终端：导航、基本命令、脚本\n- 文件系统管理：权限（chmod）、所有者、目录结构\n- 进程和服务：可视化、终止、后台任务\n- 包管理器：软件安装和更新\n- 操作系统之间的差异：内核、文件系统、许可证\n\n跨界能力：\n- 适应性：在使用Windows/macOS多年后学习新环境\n- 自主学习：文档、故障排除\n- 技术好奇心：了解\"如何\"而不仅仅是\"如何使用\"",
  ...
  "ready-to-go": {
    ...
    description: {
      zh: "数据：2025年（2025/2026学年）\n地点：学校\n\n描述：我参加了专注于高中后过渡的定向会议。我探索了三个主要方向：大学（课程、选拔、学习）、工作（实习、学徒制、聘任）以及替代路径（民间服务、间隔年）。这些会议帮助我理解不存在唯一的\"正确\"路径，而是许多具有各自优缺点的机会。我开始有意识地思考哪条路径最符合我的兴趣和能力。\n\n技术能力：\n- 大学课程：三年制学位、硕士课程、专业化\n- 就业路径：实习、学徒制、直接聘任\n- 融资：奖学金、贷款、便利措施\n- 替代机会：民间服务、出国、双元制培训\n\n跨界能力：\n- 自我认识：我真正想要什么样的未来\n- 决策能力：权衡替代方案并做出选择\n- 责任心：意识到选择的后果\n- 灵活性：认识到计划可能会改变",
  ...
  lubiana: {
    ...
    description: {
      zh: "数据：2026年4月（2025/2026学年）\n地点：卢布尔雅那（斯洛文尼亚）\n\n描述：我在一次教学旅行中访问了卢布尔雅那大学计算机科学系。我听取了大学生们关于人工智能研究项目的演讲，看到了在学术最高水平上如何运用技术。我撰写了一份综合报告，迫使我蒸馏关键概念，并思考研究中哪些方面最吸引我。这次经历为我打开了一扇窗，让我看到了文凭后继续深造意味着什么。\n\n技术能力：\n- 人工智能：应用和研究概览\n- 机器学习：基本概念、案例研究项目\n- 大学研究：方法论、出版物、融资\n- 工具和框架：人工智能生态系统概览\n\n跨界能力：\n- 积极倾听：从技术演讲中提取概念\n- 分析总结：将复杂内容简化为关键点\n- 国际视野：对欧洲背景的开放\n- 智力好奇心：对前沿研究的兴趣\n- 双语能力：在非英语环境中导航（斯洛文尼亚、学术英语）",
